...
RSpec.describe V1::Post::PersonalFeed do
  ...
  before do
    ...
    ::V1::Post::Create.(
      params: { post: { content: 'personal post' } }, current_user: current_user
    )
    ::V1::Post::Create.(
      params: { post: { content: 'post by followed user 1' } }, current_user: user1
    )
    ::V1::Post::Create.(
      params: { post: { content: 'post by followed user 2' } }, current_user: user2
    )
  end
