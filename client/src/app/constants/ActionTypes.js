...
export const NEW_REPORT_LOADING = 'NEW_REPORT_LOADING';
...
export const REPORT_FILE_FAILURE = 'NEW_REPORT_FAILURE';
export const REPORT_FILE_SUCCESS = 'NEW_REPORT_SUCCESS';
