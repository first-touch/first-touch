<template>
  <timeline-item>
    ...
    <div class="section">
      <h5 class="section-title">Senior Career</h5>
      <div class="section-item" v-for="item in careerHistory">
        <div class="team">
          ...
          <div class="team-info">
            ...
            <h6 class="location">{{ item.club.city }}, {{ item.club.country_code }}</h6>
          </div>
        </div>
        <div class="info">
          <div>
    ...
    <!-- <div class="section">
      <h5 class="section-title">National Team</h5>
    </div> -->
