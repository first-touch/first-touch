<template>
  <conversation v-if="loaded" :messages="messages" :currentUser="user.value" :sendMessage="sendMessage" :reloadConversation="reloadConversation.bind(this, { token: this.token.value })"
  />
</template>
