    ...
    <div class="container-fluid">
      ...
      <div class="col-lg-5">
        ...
        <div v-else>
          <p>
            <br />
            <strong>We’re glad you’re so excited.</strong> The build up so far had been thrilling and now we're waiting for that
            killer ball to ... what we're trying to say is, there's not much longer to wait. We're putting those finishing
            touches to the platform that will make it all worth your while.
            <br />
            <br /> So for now, please be patient with us, sign up and we'll keep you posted, get you involved and invite you for
            early access.
            <br />
            <br />
          </p>
