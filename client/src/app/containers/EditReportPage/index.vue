      ...
      <div class="ft-page ">
        ...
        <div v-if="searchReport.value.report" class="report-div">
          ...
          <div class="form-container">
            ...
            <playerreportform v-if="searchReport.value && searchReport.value.report.type_report == 'player' " :submitReport="customUpdateReport" :report="searchReport.value.report" />
            <clubreportform v-if="searchReport.value && searchReport.value.report.type_report == 'team' " :submitReport="customUpdateReport" :report="searchReport.value.report" />
          </div>
        </div>
      </div>
    </div>
