      ...
      <div class="ft-page edit-profile">
        ...
        <div class="profile-item">
          ...
          <div class="form-container">
            <edit-form v-if="loaded" :firstName="firstName" :middleName="middleName" :lastName="lastName" :month="month" :day="day" :year="year"
              :countryCode="countryCode" :placeOfBirth="placeOfBirth" :pWeight="weight" :pHeight="height" :preferredFoot="preferredFoot"
