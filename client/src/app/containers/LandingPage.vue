  ...
  <div id="root">
    ...
    <div id="fourth-page">
      <div class="flex-container">
        ...
        <div class="flex-col card player">
          <div class="front">
            <h2>PLAYERS</h2>
            <a class="bar-button center more">More</a>
          </div>
        ...
        <div class="flex-col card manager">
          <div class="front">
            <h2>MANAGERS</h2>
            <a class="bar-button center more">More</a>
          </div>
