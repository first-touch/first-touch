<template>
  <table class="table table-search">
    <thead>
      <tr v-if="type == 'player'">
        <th scope="col" class="sortable" @click="setOrder('type_report')">
          <p>Type</p>
        ...
        <th scope="col" class="sortable" @click="setOrder('player')">
          <p>Player</p>
        ...
        <th scope="col" class="sortable" @click="setOrder('playing_position')">
          <p>Position</p>
        ...
        <th scope="col" class="sortable" @click="setOrder('preferred_foot')">
          <p>P. Foot</p>
        ...
        <th scope="col" class="sortable" @click="setOrder('height')">
          <p>Height</p>
        ...
        <th scope="col" class="sortable" @click="setOrder('weight')">
          <p>Weight</p>
        ...
        <th scope="col" class="sortable" @click="setOrder('nationality_country_code')">
          <p>Nationality</p>
      ...
      <tr v-if="type == 'team'">
        ...
        <th scope="col" class="sortable" @click="setOrder('category')">
          <p>Team</p>
        ...
        <th scope="col" class="sortable" @click="setOrder('competition')">
          <p>League</p>
        ...
        <th scope="col" class="sortable" @click="setOrder('updated_at')">
          <p>Published</p>
