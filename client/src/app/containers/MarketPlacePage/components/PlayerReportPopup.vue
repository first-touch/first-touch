        ...
        <div class="info col-md-8">
          ...
          <div class="extra">
            ...
            <p class="summary-field row" v-if="playerInfo.age">
              ...
              <span class="col-md-8">{{playerInfo.age}}</span>
            </p>
            ...
            <p class="summary-field row" v-if="playerInfo.nationality_country_code">
              <span class="summary-field-title col-md-4">Nationality:</span>
              <span class="col-md-8">{{getNationality(playerInfo.nationality_country_code)}} </span>
            </p>
