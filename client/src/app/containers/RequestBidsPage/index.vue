  ...
  <div>
    ...
    <div class="ft-page">
      <div class="container">
        ...
        <div v-else>
          <team-request v-if="request.value.type_request == 'team'" :request="request.value" :toEdit="toEdit" :updateStatus="customUpdateRequest" />
          <player-request v-if="request.value.type_request == 'player'" :request="request.value" :toEdit="toEdit" :updateStatus="customUpdateRequest" />
          <position-request v-if="request.value.type_request == 'position'" :request="request.value" :toEdit="toEdit" :updateStatus="customUpdateRequest" />
