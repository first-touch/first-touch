<template>
   <timeline-item>
      ...
      <b-row>
         <b-col lg="6" md="6" sm="6" id="real-sec" >
            <div class="history_iocn"> <img src="../../../../img/united_icon.png"> </div>
            <div class="history_cont">
      ...
      <b-row>
         <b-col lg="6" md="6" sm="6" id="real-sec">
            <div class="history_iocn"> <img src="../../../../img/team_icon.png"> </div>
            <div class="history_cont">
               <h3>PORTUGAL</h3>
            </div>
         </b-col>
