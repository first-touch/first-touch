...
export default {
  ...
  computed: {
    ...mapGetters(['user']),
    loaded() { return this.user.status === ASYNC_SUCCESS; },
    personalProfile() {
    ...
    firstName() { return this.personalProfile.first_name || ''; },
    middleName() { return this.personalProfile.middle_name || ''; },
    ...
    height() { return this.personalProfile.height; },
    preferredFoot() { return this.personalProfile.preferred_foot || ''; }
  },
  methods: {
