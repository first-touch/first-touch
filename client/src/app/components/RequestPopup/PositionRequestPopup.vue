        ...
        <div class="info col-lg-8" v-if="request.type_request == 'position'">
          ...
          <p class="extra">
            ...
            <span class="field row">
              ...
              <span class="col-lg-6" v-if="request.meta_data.expiring_contract_min || request.meta_data.expiring_contract_max ">{{ request.meta_data.expiring_contract_min | moment}} to {{ request.meta_data.expiring_contract_max | moment}}</span>
            </span>
            <span class="field row">
