  ...
  <div class="wrapper ft-item">
    <div class="header-wrapper col-lg-12">
      <div class="header col-lg-12 row">
        ...
        <div class="col-lg-8 buttons-inner" v-if="typeof closeAction !== 'undefined'">
          ...
          <p class="extra">
            <span>
              <span class="field row" v-if="request.team">
                <span class="col-lg-4">Team: </span>
                <span class="col-lg-6">{{ request.team.team_name}}
                </span>
              </span>
              <span class="field row" v-if="request.league">
                <span class="col-lg-4">League: </span>
                <span class="col-lg-6">{{ request.league.name}}
                </span>
              </span>
              <span class="field row">
                <span class="col-lg-4">Age: </span>
                <span class="col-lg-6" v-if="!request.player">{{ request.meta_data.age}}
                </span>
              ...
              <span class="field row">
                ...
                <span class="col-lg-6" v-if="!request.player">{{ request.meta_data.preferred_foot | preferredFoot}}
                </span>
                <span class="col-lg-6" v-if="request.player">{{ request.player.preferred_foot | preferredFoot}}
                </span>
              </span>
              <span class="field row">
              ...
              <span class="field row">
                ...
                <span class="col-lg-6" v-if="!request.player">{{getNationality(request.meta_data.nationality_country_code)}}
                </span>
                <span class="col-lg-6" v-if="request.player">{{getNationality(request.player.nationality_country_code)}}
                </span>
              </span>
              <span class="field row">
                ...
                <span class="col-lg-6" v-if="request.player">{{getNationality(request.player.residence_country_code)}}
                </span>
              </span>
            </span>
            <span class="field row">
