...
export default {
  ...
  props: [
    'firstName', 'middleName', 'lastName', 'month', 'day', 'year', 'countryCode', 'placeOfBirth', 'pWeight', 'pHeight', 'preferredFoot',
    'updateUserInfo'
  ],
  data() {
    return {
  ...
  methods: {
    handleSubmit() {
      const { first_name, last_name, bMonth, bDay, bYear, place_of_birth, weight, height, preferred_foot } = this;
      ...
      this.updateUserInfo({
        first_name, last_name, birthday, nationality_country_code,
        residence_country_code, place_of_birth, weight, height, preferred_foot
      });
    }
  }
}
