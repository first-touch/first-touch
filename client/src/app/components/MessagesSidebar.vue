 ...
 <div class="input-group">
  <div class="nav-item">
    ...
    <div class="container">
      ...
      <div class="list">
            <ul>
             <li class="hover_sec_tac">
              	<a href="#"><span>Lionel Messi</span><br>When are you coming...</a>
              </li>
              
              <li>
              	<a href="#"><span>Nani</span><br>When are you coming...</a>
              </li>
              
              <li>
              	<a href="#"><span>John Sample, Juan Sanchez, Andrew...</span><br>When are you coming...</a>
              </li>
              <li>
              	<a href="#"><span>José Mourinho</span><br>When are you coming...</a>
              </li>
              <li>
              	<a href="#"><span>Kaká</span><br>When are you coming...</a>
              </li>
              <li>
              	<a href="#"><span>Bruno Marmo</span><br>When are you coming...</a>
              </li>
              <li>
              	<a href="#"><span>Luis Carmona</span><br>When are you coming...</a>
              </li>
              <li>
              	<a href="#"><span>Felipe Coutinho</span><br>When are you coming...</a>
              </li>
            </ul>
          </div>
