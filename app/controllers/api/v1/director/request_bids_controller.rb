  ...
  module V1
    module Director
      class RequestBidsController < Api::V1::BaseController
        def index
          result = ::V1::RequestBid::Operation::Director::Index.(params: params, current_user: current_user)
          response = FirstTouch::Endpoint.(result, ::V1::RequestBid::Representer::Index)
          render json: response[:data], status: response[:status]
        end

        def create
          result = ::V1::Request::AcceptBid.(params: params, current_user: current_user)
